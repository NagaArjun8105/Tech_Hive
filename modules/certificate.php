...
$course = isset($_GET['course']) ? htmlspecialchars($_GET['course']) : "Your Course";
?>
    ...
    <div class="container mt-5">
        ...
        <div class="certificate-container">
            <div id="certificate" class="certificate">
                ...
                <p class="company"><?= $course ?></p>
                <p>AT TECH HIVE</p>
                <img src="logo.jpeg" class="seal" width="150px" height="150px" alt="Seal">
                <div class="footer">
        ...
        function downloadCertificate() {
            html2canvas(document.getElementById("certificate")).then(canvas => {
                ...
                setTimeout(() => {
                    ...
                    window.location.href = "../cousre.html";
                }, 2000);
            });
        }
    </script>
